...
const ContenidoCurso = () => {
    console.table(cursos.cursos[0].modulos.length)
    const mostrarModulos = (modulosDelCurso) => {

        return modulosDelCurso.map( (modulo, index) => {
    ...
    return(
        <>
            ...
            {mostrarModulos(cursos.cursos[0].modulos)}
